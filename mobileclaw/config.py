...
class AgentConfig:
    ...
    temp_file_retention_days: float = field(default=1.0, metadata={"help": "Retention period in days for temporary files under agent_dir/_temp. Cleanup runs on this same interval; set to 0 or a negative value to disable automatic cleanup."})
    ...
    chat_verbose: bool = field(default=False, metadata={"help": "If True, chat clients also send automatic system status replies such as manager/report receiver auto-bind notices."})

...
- [openclaw](https://github.com/openclaw/openclaw)和[ClawPhone](https://www.clawphone.app/) 提供的灵感。
- [OmniMind team](https://omnimind.com.cn/)（万象智维）提供的灵感和支持。
- [nanobot](https://github.com/HKUDS/nanobot) 提供的灵感和开源的聊天频道集成示例代码。

...
[![Android App](https://img.shields.io/badge/Android%20App-下载-16a34a?style=flat-square)](https://github.com/MobileClaw/MobileClaw/releases/latest/download/MobileClaw.apk)
...
- 下载并安装 [MobileClaw Android app](https://github.com/MobileClaw/MobileClaw/releases/latest/download/MobileClaw.apk)。
- 完成模型与聊天通道配置。
- 点击启动按钮即可开始使用。

更多说明请访问我们的[项目网站](https://mobileclaw.github.io)。
...
<details>
<summary><strong>Lark/飞书</strong></summary>
